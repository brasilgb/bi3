...
export const DreLoading = ({ rows = 8 }: { rows?: number }) => (
...
export const DreError = ({ onRetry }: { onRetry: () => void }) => (
  <div className="flex flex-col items-center justify-center gap-2 p-10 bg-white/60 text-gray-500">
    <IoAlertCircleOutline size={32} className="text-solar-red-support" />
    <p className="text-sm">Não foi possível carregar os dados do DRE.</p>
    <button
      onClick={onRetry}
