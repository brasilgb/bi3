          ...
          <tbody>
            {dreEstrutura
              ...
              .map((estrutura: any, idx: any) => (
                <BTr
                  key={idx}
                  classname={`${idx % 2 === 0 ? 'bg-gray-100' : 'bg-neutral-50'} text-sm transition-colors duration-150 hover:bg-solar-blue-primary/10 ${lineTotal(estrutura.EstruturaId) && '!bg-gray-200'}`}
                >
